    ...
    return html`  
      ...
      ${isArray ? html`
          ...
          >
            ...
            <div style="font-size:65%;border-color:white;color:white;background-color:#ef473a;"
...
const dumpObject = tag(({
  ...
  return html`
    <div style="flex: 1 1 10em;">
      ...
      >
        ${key && html`
          <a style="font-size:65%;color:white;border-color:white;flex-grow:1;background-color:#387ef5;"
...
function dumpSimple({key, value, onHeaderClick}: {
  ...
  return html`
    <div style="font-size:75%;flex:1 1 10em;color:#111111">
      ${key && html`
        <div class="border-bottom" style="font-size:65%;border-color:white;line-height: 95%;font-weight:bold;"
