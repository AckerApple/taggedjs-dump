  ...
  function objectTemplate(): Tag {
    ...
    return html`  
          ...
          <div style="position:relative;">
            <div style="display:flex;font-size:50%;position:absolute;top:-18px;right:-6px">
              ${!format || format==='small' && html`
                <a
                  style="margin:1px;border-radius:5px;color:white;align-items:center;display:flex;"
                  class=${'pad-h-xxs hover-bg-balanced ' + (showAll ? 'bg-balanced' : 'bg-dark')}
              ...
              <a
                style="margin:1px;border-radius:5px;color:white;align-items:center;display:flex;"
                class=${'pad-h-xxs hover-bg-balanced ' + (!format || format==='small' ? 'bg-positive' : 'bg-dark')}
                onclick=${() => formatChange(format='small')}
              >small</a>
              <a style="margin:1px;border-radius:5px;color:white;align-items:center;display:flex;"
                class=${"pad-h-xxs hover-bg-balanced " + (format==='json' ? 'bg-positive' : 'bg-dark')}
                onclick=${() => formatChange(format='json')}
              >json</a>
              <a style="margin:1px;border-radius:5px;color:white;align-items:center;display:flex;"
                class=${"pad-h-xxs hover-bg-balanced active-bg-energized " + (format==='json' ? 'bg-positive' : 'bg-dark')}
      ...
      ${isArray ? html`
          ...
          >
            <div class="pad-xxs flex-apart"
              style=${
                "flex-grow:1;font-size:65%;border-color:white;color:white;background-color:#ef473a;" +
