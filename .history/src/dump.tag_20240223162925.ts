  ...
  function objectTemplate(): Tag {
    ...
    return html`  
      ...
      ${isArray ? html`
          <!-- array -->
          <div
            style="background-color:#f2dede;border:1px solid black;border-radius:5px;flex-direction: column;display:flex"
            class="text-dark"
          >
...
const dumpObject = tag(({
  ...
  return html`
    <div style="flex: 1 1 10em;">
      <div
        style="background-color:#d9edf7;border:1px solid black;border-radius:5px;flex-direction: column;display:flex;"
