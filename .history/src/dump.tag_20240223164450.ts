    ...
    return html`  
      ${isRootDump && html`
        <div style="width: 100%;line-height: 90%;">
          <div style="position:relative;">
            <div class="child-margin-1 flex"
              style="font-size:50%;position:absolute;top:-18px;right:-6px"
            >
              ...
              >small</a>
              <a style="border-radius:5px;color:white;"
      ...
      ${isArray ? html`
          ...
          >
            ...
            <div style=${"font-size:65%;border-color:white;color:white;background-color:#ef473a;" + show ? 'border-bottom-width:1px;border-bottom-style:solid;border-color:black;':''}
              class="pad-xxs flex-1 flex-apart"
            >
