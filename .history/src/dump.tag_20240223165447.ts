    ...
    return html`  
      ...
      ${isArray ? html`
          ...
          >
            <div class="pad-xxs"
              style=${
                "display:flex;justify-content:space-between;flex-grow:1;font-size:65%;border-color:white;color:white;background-color:#ef473a;" +
    ...
    <div style="flex: 1 1 10em;">
      ...
      >
        ${key && html`
          <a
            style=${
              "fdisplay:flex;justify-content:space-between;font-size:65%;color:white;border-color:white;flex-grow:1;background-color:#387ef5;" +
