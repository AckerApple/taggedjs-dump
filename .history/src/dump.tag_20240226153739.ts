...
export const dump = tag(({
  ...
  console.log('showAll 1', showAll)
  
  const test = setProp(x => [showAll, showAll = x])

  console.log('showAll 2', {showAll, test})
...
const dumpObject = tag(({
  ...
  console.log('dumpObject showAll', showAll)
