    ...
    return html`  
      ...
      ${isArray ? html`
          ...
          >
            ...
            <div style="border-color:white;color:white;background-color:#ef473a;"
              class="text-xxs pad-xxs flex-1 flex-apart"
...
const dumpObject = tag(({
  ...
  return html`
    <div style="flex: 1 1 10em;">
      <div
        style="color:#111111;background-color:#d9edf7;border:1px solid black;border-radius:5px;flex-direction: column;display:flex;"
        class="text-sm"
      >
        ${key && html`
          <a style="color:white;border-color:white;flex-grow:1;background-color:#387ef5;"
            class="text-xxs pad-xxs flex-apart"
...
function dumpSimple({key, value, onHeaderClick}: {
  ...
  return html`
    <div class="text-xs" style="flex:1 1 10em;color:#111111">
      ${key && html`
